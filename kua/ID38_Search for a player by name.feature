...
So I can view his/her profile or add him/her to my friend list
  ...
  Scenario: (Alternate Flow) Search for a player but the name is incorrect
     When I search for a player with his/her incorrect name
     Then no player should be found 
      And system shall display warning message to me that can not find player with this name
