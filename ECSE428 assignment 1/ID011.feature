Feature: ID11_View which team win the game

    User Stories:
    As a Player
    I want to view which team wins the game
    ...
    Scenario Outline: (Alter Flow) I can not see the game result because the host reset the game
               When all players finished voting
